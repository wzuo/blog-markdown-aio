...
def test_get_blog_posts(mock_open, mock_os):
    ...
    mock_open.return_value.__enter__.return_value.readlines.side_effect = [
        [
            'Title', 'Sub', '2016-03-03T11:22:00', 'test-slug', 'X', '', 'A'
        ],
        [
        ...
        [
            'Title 3', 'Sub 3', '2016-03-03T12:25:00', 'test-slug-3', 'D',
            'disable_comments', 'C',
        ],
    ]
    ...
    assert posts == [
        Post(
            ...
            slug='test-slug-3', author='D',
            options={'disable_comments': True}, content='<p>C</p>'),
        Post(
            title='Title 1', subtitle='Sub 1', date='2016-03-03T11:28:00',
            slug='test-slug-1', author='P', options={}, content='<p>B</p>'),
        Post(
            title='Title 2', subtitle='Sub 2', date='2016-03-03T11:25:00',
            slug='test-slug-2', author='D', options={}, content='<p>C</p>'),
        Post(
            title='Title', subtitle='Sub', date='2016-03-03T11:22:00',
            slug='test-slug', author='X', options={}, content='<p>A</p>'),
    ]
